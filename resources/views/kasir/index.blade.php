...
<div class="row">
    <div class="col">
        ...
        <div class="card">
            <div class="card-header">
                <h4> <strong>TB. Penjualan</strong></h4>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Harga + Kenaikan</th>
                            <th scope="col">Harga Beli</th>
                            <th scope="col">Sub Total Normal</th>
                            <th scope="col">Sub Total + Kenaikan</th>
                            <th scope="col">Sub Total Beli</th>
                            <th scope="col">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
